---
page_title: "anypoint_brand_new_thing Resource - terraform-provider-anypoint"
subcategory: "Access Management"
description: |-
  Manages an Anypoint Platform team.
---

# anypoint_brand_new_thing (Resource)
...
resource "anypoint_brand_new_thing" "example" {
...
resource "anypoint_brand_new_thing" "sub_team" {
  provider = anypoint.admin
  team_name      = "Frontend Team"
  parent_team_id = anypoint_brand_new_thing.example.id
  team_type      = "internal"
}
```
...
```shell
terraform import anypoint_brand_new_thing.example <team_id>
```
